  ...
  return (
    <AuthGuard>
      <div className={embedded ? '' : 'min-h-screen bg-slate-50'}>
        {!embedded && <AppHeader />}
        {!embedded && <PatientHeader patientId={patientId} />}
        <main
          className={
            embedded
              ? 'p-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-3'
              : 'max-w-6xl mx-auto px-6 pt-4 pb-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3'
          }
        >
